...
require (
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-gin v0.0.1
	github.com/mario-imperato/tpm-common v0.0.1
	github.com/rs/zerolog v1.26.1
	gitlab.alm.poste.it/go/configuration v1.5.5
	gitlab.alm.poste.it/go/observability/tracing v1.0.0
)
...
require (
	...
	gitlab.alm.poste.it/go/crypto/cipher v1.5.4 // indirect
	gitlab.alm.poste.it/go/secret/provider v1.5.5 // indirect
